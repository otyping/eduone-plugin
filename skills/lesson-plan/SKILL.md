...
- **ความละเอียดของกิจกรรมมีเพดาน**: ไม่เกิน 6 ข้อต่อขั้น · ข้อละไม่เกิน 220 อักษร ·
  **ขั้นวัดผลการเรียนรู้เป็นข้อความสำเร็จรูปบรรทัดเดียว** ("ให้นักเรียนทำแบบฝึกหัดของคาบนี้ด้วยตนเอง ประมาณ 10 ข้อ ครูเดินสังเกตและเก็บไปตรวจ")
  writer ไม่ต้องเขียนแถวนี้เอง ทั้งหมดนี้ `validate_spec` ตรวจให้แล้ว
