...
**ตั้งเป้าที่ ~20 หน้าต่อชุด · WARN เมื่อเกิน 22 · FAIL เมื่อเกิน 30**
(เจ้าของโปรเจกต์กำหนดจากการสอนจริง: "ไม่ควรเกิน 30 หน้า เต็มที่ 20 หน้ายังเพียงพอเลย
ใช้แค่สาระสำคัญ ๆ เอามาขึ้นสไลด์ ไม่จำเป็นต้องเอามาหมด")

> เดิมบรรทัดนี้เขียนว่า "ตั้งเป้า ≤ 36" ผลคือ writer ทุกตัวเล็งไปที่ 36 ไม่ใช่ 20
> (วัดจริง: C1 28 · C2 32 · L1 26 หน้า) — ตอนนี้เพดานอยู่ใน `validate_spec` แล้ว
> ไม่ใช่แค่คำแนะนำใน prompt
